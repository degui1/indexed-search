...
import { spinner, printBanner, printConfig, printBuildMetrics, printResults, printError } from './ui.js'
...
async function main() {
  ...
  program
    ...
    .option('--algorithm <name>', 'override config algorithm (linear | inverted-index | trie | tfidf)')
